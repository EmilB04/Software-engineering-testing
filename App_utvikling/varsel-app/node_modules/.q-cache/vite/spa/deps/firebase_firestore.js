...
var __PRIVATE_WebChannelConnection = class extends class __PRIVATE_RestConnection {
  ...
  Bo(e, t, n) {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.xmlHttpFactory = new FetchXmlHttpFactory({})), this.Oo(_.initMessageHeaders, t, n), _.encodeInitMessageHeaders = true;
    const u = i.join("");
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          void 0 === n3 && (n3 = v.INTERNAL, i3 = "Unknown error status: " + t3 + " with message " + o2.message), h = true, P.So(new FirestoreError(n3, i3)), c.close();
        } else
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e), await this.Wa.initialize(this, e), await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Wa.syncEngine), await __PRIVATE_fillWritePipeline(this.Wa.remoteStore), await this.persistence.yi(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  createLocalStore(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
  }
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(e, t, false), this.Wa = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.ja = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.Ha = function __PRIVATE_newTextDecoder() {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r, this.deferred = i, this.nu = n.maxAttempts, this.t_ = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry");
  }
  ru() {
    this.nu -= 1, this.iu();
  }
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(S, "4.7.2", e), registerVersion(S, "4.7.2", "esm2017");
}();
export {
